...
try:
    ...
    # Setup path like the MCP server entrypoint does
    ...
    print("DEBUG: Importing controller...", file=sys.stderr, flush=True)
    import kinova_middleware.backend.controller
    print("DEBUG: controller imported.", file=sys.stderr, flush=True)
    ...
    print("DEBUG: Importing mcp_server.app...", file=sys.stderr, flush=True)
    import kinova_middleware.backend.mcp_server.app
    print("DEBUG: mcp_server.app imported.", file=sys.stderr, flush=True)
